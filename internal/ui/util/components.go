...
var (
	TableComponentShortcutDown = shortcut_helper.ShortcutEntry{KeyCombo: []string{"⬇️"}, Name: "Select Next Item"}
	TableComponentShortcutUp   = shortcut_helper.ShortcutEntry{KeyCombo: []string{"⬆️"}, Name: "Select Previous Item"}
